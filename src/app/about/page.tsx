...
const AboutUsPage = () => {
  ...
  const stickyContent = {
    ...
    // Using JSX for potentially richer text formatting
    text: (
      <>
        <p className="mb-4">
          At HWC, our strength lies in our people. We are a collective of
          experienced, client-focused advisors committed to the highest
          standards of integrity and service.
        </p>
        <p>
          Each member brings unique expertise, allowing us to provide truly
          comprehensive guidance across all facets of your financial life. Get
          to know the team dedicated to your success.
        </p>
      </>
    ),
  };
