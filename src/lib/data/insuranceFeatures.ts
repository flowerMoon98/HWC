  ...
  export const mockInsuranceFeatures: InsuranceFeature[] = [
    {
      ...
      description: "From life and health insurance to homeowners and auto coverage, we help you find policies that fit your individual needs and budget.",
    ...
    },
    {
      ...
      description: "Protect your business with comprehensive coverage options, including general liability, professional liability (E&O), and commercial property insurance.",
    ...
    },
    {
      ...
      description: "We also assist with specialized insurance needs, such as umbrella policies, long-term care insurance, and disability insurance.",
