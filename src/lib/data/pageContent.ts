...
export const aboutUsHeroContent = {
  title: 'Our Mission',
  subtitle:
    'To empower our clients with clarity and confidence through integrated financial, healthcare, and property guidance.',
...
export const insuranceHeroContent = {
  ...
  subtitle:
    'Protecting what matters most, from personal assets to business continuity.',
  backgroundColorClass: 'bg-[var(--color-hwc-blue-light)]',
  ctaButton: {
    text: 'Request a Consultation',
    href: '/contact',
    variant: 'default' as const,
  }, // Use 'as const' for variant type safety
};
...
export const whyChooseUsContent = {
  ...
  linkHref: '/about', // Example link (maybe link to services?)
};
