...
export const mockTestimonials: Testimonial[] = [
  {
    id: 1,
    quote:
      "Working with HWC was a game-changer for our financial planning. Their insights were invaluable, and the process was seamless.",
  ...
  },
  {
    id: 2,
    quote:
      "The team provided clear, actionable advice for our healthcare planning needs. We feel much more secure about the future.",
  ...
  },
  {
    id: 3,
    quote:
      "Navigating property investment seemed daunting, but HWC made it straightforward and profitable. Highly recommended!",
