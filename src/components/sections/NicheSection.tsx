...
// Service data
const nicheServices = [
  { id: 'ins', title: 'Insurance Planning', description: 'Placeholder description for Insurance Planning services. Lorem ipsum dolor sit amet.', href: "/services/insurance" },
  { id: 'acc', title: 'Accounting', description: "Placeholder description for Accounting services. Pellentesque cursus auctor dolor.", href: "/services/accounting" },
  { id: 'wm', title: 'Wealth Management', description: "Placeholder description for Wealth Management services. Vestibulum porttitor libero.", href: "/services/wealth-management" },
  { id: 'hc', title: 'Healthcare Planning', description: 'Placeholder description for Healthcare Planning services. Etiam mollis urna erat.', href: "/services/healthcare-planning" },
  { id: 'prop', title: 'Property Guidance', description: 'Placeholder description for Property Guidance services. Et dignissim odio imperdiet non.', href: "/services/property" },
];
        ...
        >
          {nicheServices.map((service, index) => (
            ...
            >
              ...
              <div className="flex-grow flex flex-col pr-6"> {/* Keep right padding for text */}
                {/* Heading */}
