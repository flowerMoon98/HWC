            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-12">
              ...
              {teamMembers.map((member) => (
                ...
                <div key={member.id} className="text-center group">
                  ...
                  <div className="relative h-48 w-48 mx-auto mb-4  overflow-hidden shadow-md transition-transform duration-300 group-hover:scale-105"> {/* Example hover effect */}
                    <Image
                  ...
                  {/* Member Role */}
                  <p className="text-sm text-[var(--color-hwc-teal)]"> {/* Use theme teal color */}
                    {member.role}
                  </p>
                  {/* Optional Member Bio */}
                  {member.bio && (
