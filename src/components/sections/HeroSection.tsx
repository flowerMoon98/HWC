...
const HeroSection: React.FC<HeroProps> = ({
  ...
  const textColorClass = backgroundImageUrl
    ? "text-[var(--color-hwc-white)]"
    : "text-[var(--color-hwc-dark)]";
  const subtitleColorClass = backgroundImageUrl
    ? "text-gray-200"
    : "text-gray-600";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {children && (
          <div className={cn("mt-10", textColorClass)}>{children}</div>
        )}
      </div>
    </section>
  );
