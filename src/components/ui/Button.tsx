  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-full border text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border-transparent',
  {
    variants: {
      variant: {
        ...
        pill: // REMOVED hover:bg, kept data-state style and text colors
          'bg-transparent text-[var(--color-hwc-white)] data-[state=open]:bg-[var(--color-hwc-blue-light)] data-[state=open]:text-[var(--color-hwc-dark)] border-transparent transition-colors duration-300 ease-in-out', // Keep transition for text/active bg
        light:
          'bg-[var(--color-hwc-white)] text-[var(--color-hwc-dark)] border-[var(--color-hwc-dark)] hover:bg-gray-100',
        dark:
          'bg-[var(--color-hwc-dark)] text-[var(--color-hwc-white)] hover:opacity-90 border-[var(--color-hwc-dark)]',
        info:
          'bg-[var(--color-hwc-blue-light)] text-[var(--color-hwc-dark)] hover:opacity-90 border-[var(--color-hwc-blue-light)]',
        'teal-dark':
          'bg-[var(--color-hwc-teal-dark)] text-[var(--color-hwc-white)] hover:opacity-90 border-[var(--color-hwc-teal-dark)]',
        destructive:
          'bg-red-600 text-white hover:bg-red-600/90 border-red-700',
        outline:
        ...
        ghost:
          'hover:bg-gray-100 hover:text-gray-800 border-transparent',
        link:
          'text-blue-600 underline-offset-4 hover:underline rounded-none h-auto px-1 py-0 border-transparent',
      },
      size: {
        default: 'h-9 px-6',
